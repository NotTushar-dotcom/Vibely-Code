...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      <h1 className='md:text-4xl text-2xl font-semibold'>Subscribe to Our Newsletter</h1>
      <p className='md:text-lg text-gray-500/70 pb-8'>Get the latest tutorials and updates delivered straight to your inbox.</p>
      <form className='flex items-ceter justify-between max-w-2xl w-full md:h-13 h-12'>
